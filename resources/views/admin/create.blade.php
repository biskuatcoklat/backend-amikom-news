        ...
        <main class="w-full flex-row p-6">
            ...
            <div class="leading-loose">
                ...
                <form class="p-10 bg-white rounded shadow-xl" action="/admin/news/create/post" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="Category" class="block mb-2 text-sm font-medium text-gray-900 ">Content</label>
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700">
                            <div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-200">
